  ...
  <button class=" px-4 py-2  bg-red-600  w-28 text-white  rounded-lg  hover:opacity-90 hover:text-black hover:bg-emerald-500 mb-4">Load</button>
   ...
   <div className='mt-5  border w-80 md:w-full  rounded-lg'>
    <div className='flex flex-col md:flex-row justify-around items-center mt-2'>
     ...
     <input type="text" name="name" id="name" placeholder="" class="border  border-gray-300 rounded-md px-2 py-2 mb-4 w-48"/>
      </div>
      <div className='flex flex-col gap-1'>
      <label for="id" class="mb-2 text-sm">Employee Name</label>
  <input type="text" name="employee_name" id="employee_name" placeholder="" class="border text-sm border-gray-300 rounded-md px-2 py-2 mb-4 w-48"/>
      </div>
      <div className='flex flex-col gap-1'>
      <label for="id" class="mb-2 text-sm">Employee ID</label>
     <input type="text" name="id" id="id" placeholder="" class="border border-gray-300 rounded-md px-3 py-2 mb-4 w-48"/>
      </div>
    </div>
    ...
    <div className='flex flex-col gap-1'>
      ...
      <input type="text" name="Role" id="Role" placeholder="" class="border border-gray-300 rounded-md px-3 py-2 mb-4 w-48"/>
      </div>
      <div className='flex flex-col gap-1'>
      <label for="id" class="mb-2 text-sm">Employee Branch</label>
      <input type="text" name="Branch" id="Branch" placeholder="" class="border border-gray-300 rounded-md px-3 py-2 mb-4 w-48"/>
      </div>

      <div className='flex flex-col gap-1'>
  <label htmlFor="password" className="mb-2 text-sm">Password</label>
  <input type="password" id="password" name="password" placeholder="" className="border border-gray-300 rounded-md px-3 py-2 mb-4 w-48" />
</div>
...
<div className='flex justify-between  items-center'>
    ...
    <Link to="/edituser" class="px-4 py-2  bg-red-600  w-32 text-white  rounded-lg  hover:opacity-90 hover:text-black hover:bg-emerald-500 mb-2 mr-4">Edit</Link>
</div>
